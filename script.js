...
document.getElementById("toggleButton").addEventListener("click", function () {
   ...
   const hiddenSignupElement=document.getElementById("hiddenSignupElement");
   hiddenElement.classList.toggle("visually-hidden");
   hiddenSignupElement.classList.add("visually-hidden");

});
document.getElementById("toggleSignupButton").addEventListener("click", function () {
   const hiddenElement = document.getElementById("hiddenSignupElement");
   const hiddenSignupElement=document.getElementById("hiddenElement");
